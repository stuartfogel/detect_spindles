...
if PARAM.emptyparam == 1
    PARAM = struct(...
        ...
        ,'channels_of_interest',{{'C3','O1'}} ... selected channels. Default: {{'Fz','Cz','Pz'}}
        ,'ZSwindowlength', 60 ... window for ZSCORE (in seconds). Default: [60].
        ,'ZSThreshold', 2.33 ... Threshold for the ZScore. Default: [2.33].
        ,'ZSResetThreshold', 0.1 ... Value for the reset. Default: [0.25].
        ,'ZSBeginThreshold', 0.1 ... Value to detect the begining of spindles. Default: [0.25].
        ,'ZSDelay', 0.25 ... minimum delay btw 2 spindles on the same channel (sec.). Default: [0.25].
        ,'minDur', 0.49 ... minimum spindle duration. Default: [0.25].
        ,'eventName', {{'Spindle'}} ... name of event. Default: {{'Spindle'}}.
        ,'allsleepstages', {{'NREM 1','NREM 2','NREM 3','NREM 4','REM','Wake','unscored'}} ... name of all sleep stage markers. Default: {{'N1','N2','N3','N4','REM','W','unscored'}}.
        ,'goodsleepstages', {{'NREM 2','NREM 3','NREM 4'}} ... name of sleep stage markers to keep spindle events. Default: {{'N2','N3','N4'}}.
