function [com] = pop_detect_spindles(EEG)
...
% GUI geometry setup
g = [3, 2];
geometry = {1,g,g,g,g,1,g,g,1,g,g,1,g,g,g,g,1,1,1 [2 2 1]};
geomvert = [1 1 1 1 1 2 1 1 2 1 1 2 1 1 1 1 2 1 1 1];
...
if ~isempty(result)
    ...
    PARAM = struct(...
        ...
        ,'badData', result{4} ...
        ,'cdemod_freq', str2double(result{5}) ...
        ,'cdemod_filter_lowpass', str2double(result{6}) ...
        ,'rmshp', str2double(result{7}) ...
        ,'rmslp', str2double(result{8}) ...
        ,'ZSThreshold', str2double(result{9}) ...
        ,'ZSwindowlength', str2double(result{10}) ...
    ...
    % launch pipeline
    detect_spindles(EEG,PARAM);
else
    com = '';
    return
end

com = [ com sprintf('pop_detect_spindles( %s);', inputname(1)) ];
